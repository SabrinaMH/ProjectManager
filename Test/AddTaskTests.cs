...
namespace Test
{
    ...
    public class AddTaskTests
    {
        ...
        public async Task When_Adding_A_Task_Then_It_Appears_In_The_Task_List()
        {
            ...
            var postTaskResponse = await _httpClient.PostAsJsonAsync(_projectEndpoint, taskInputModel);
            ...
            var getTasksResponse = await _httpClient.GetAsync(_projectEndpoint);
